...
*For those interested in seeing how I computed all of the numbers in this post and the [last post](/2021/11/23/mask-rct-revisited/), [here is a Jupyter notebook.](https://nbviewer.jupyter.org/url/archives.argmin.net/code/revisiting-bd-mask-rct.ipynb)*
