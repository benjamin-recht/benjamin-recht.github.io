...
{: .center}
![position](/assets/rl/policies/cost_finite.png){:width="270px"}
...
{: .center}
![position](/assets/rl/policies/cost_finite_err_bars.png){:width="500px"}
...
{: .center}
![position](/assets/rl/policies/cost_infinite.png){:width="300px"}
...
{: .center}
![position](/assets/rl/policies/stabilizing.png){:width="270px"}
