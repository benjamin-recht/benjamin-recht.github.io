...
Moreover, the video linked above solves for the controller in 7x real time in 2012. Which is really not bad, and probably with a dedicated engineer, this could be made into real time using up-to-date hardware. However, note that in 2013, the same research group published a [cruder version of their controller that they used during the DARPA robotics challenge](https://ieeexplore.ieee.org/document/7029990). The video here is just as impressive:
