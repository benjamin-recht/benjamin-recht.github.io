...
Moreover, the video linked above solves for the controller in 7x real time in 2012. Which is really not bad, and probably with a dedicated engineer, this could be made into real time using up-to-date hardware. However, note that in 2013, the same research group published a [cruder version of their controller that they used during the DARPA robotics challenge](https://web.archive.org/web/20170810225214/https://homes.cs.washington.edu/~todorov/papers/ErezHumanoids13.pdf). The video here is just as impressive:

<div style="text-align: center">
<iframe width="420" height="315" src="https://web.archive.org/web/20180502234737/https://homes.cs.washington.edu/~todorov/media/ErezHumanoids13.mp4" frameborder="0" allowfullscreen></iframe></div>
