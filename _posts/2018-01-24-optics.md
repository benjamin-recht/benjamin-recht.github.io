...
{: .center}
![BUT HER EMAILS](/assets/optics/email.png | width=250)
...
{: .center}
![My eyes hurt](/assets/optics/lens.png | width=400)
...
{: .center}
![refraction](/assets/optics/refraction.gif | width=130)
{: .center}
![reflection](/assets/optics/reflection.jpg | width=130)
{: .center}
![diffraction](/assets/optics/diffraction.jpg | width=130)
{: .center}
![dispersion](/assets/optics/dispersion.jpg | width=130)
{: .center}
![wavefront correction](/assets/optics/wavefront-correction.png | width=130)
...
{: .center}
![Absractions all the way down](/assets/optics/abstractions.png | width=250)
...
{: .center}
![Alchemy up top, science at the bottom](/assets/optics/optics-scorecard.png | width=300)
...
{: .center}
![And yet it magnifies](/assets/optics/galileo.jpg | width=250)
...
{: .center}
![You're fired](/assets/optics/deeplearning-scorecard.png | width=300)
