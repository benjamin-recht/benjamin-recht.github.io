...
{: .center}
![My eyes hurt](/assets/optics/lens.png){:width="400px"}
...
{: .center}
![refraction](/assets/optics/refraction.gif){:width="130px"}
![reflection](/assets/optics/reflection.jpg){:width="130px"}
![diffraction](/assets/optics/diffraction.jpg){:width="130px"}
![dispersion](/assets/optics/dispersion.jpg){:width="130px"}
![wavefront correction](/assets/optics/wavefront-correction.png){:width="130px"}
...
{: .center}
![Alchemy up top, science at the bottom](/assets/optics/optics-scorecard.png){:width="450px"}
...
{: .center}
![You're fired](/assets/optics/deeplearning-scorecard.png){:width="450px"}
