...
{: .center}
![position](/assets/rl/policies/cost_infinite_datacenter.png){:width="260px"}
![position](/assets/rl/policies/stabilizing_datacenter.png){:width="260px"}
...
{: .center}
![position](/assets/rl/policies/cost_infinite_datacenter_1336.png){:width="275px"}
![position](/assets/rl/policies/stabilizing_datacenter_1336.png){:width="275px"}
