...
{: .center}
![fake datacenter](/assets/rl/fake_datacenter.png){:width="560px"}
...
{: .center}
![hard instance inf](/assets/rl/policies/cost_infinite_datacenter.png){:width="260px"}
![hard instance stabilizing](/assets/rl/policies/stabilizing_datacenter.png){:width="260px"}
...
{: .center}
![don't tune on random seeds](/assets/rl/policies/cost_infinite_datacenter_1336.png){:width="275px"}
![this doesn't look good](/assets/rl/policies/stabilizing_datacenter_1336.png){:width="275px"}
