...
{: .center}
![position](/assets/rl/policies/cost_infinite_datacenter.png){:width="560px"}
![position](/assets/rl/policies/stabilizing_datacenter.png){:width="412px"}
...
{: .center}
![position](/assets/rl/policies/cost_infinite_datacenter_1336.png){:width="560px"}
![position](/assets/rl/policies/stabilizing_datacenter_1336.png){:width="412px"}
