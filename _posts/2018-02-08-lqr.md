...
where the $M_k$ are precisely the ones we derived above. That is, the \emph{cost-to-go} or \emph{value} functions of the LQR problem are quadratics, and they are defined by the sequence $M_k$ derived above.
