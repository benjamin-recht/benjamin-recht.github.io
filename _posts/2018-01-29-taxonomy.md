...
{: .center}
![The ML Taxonomy](/assets/rl/taxonomy.png){:width="250px"}
...
{: .center}
![recent bedroom](/assets/rl/bedroom.png){:width="160px" height="90px"}
![hot topic](/assets/rl/ml-word-cloud.jpg){:width="160px" height="90px"}
![so delicious](/assets/rl/swiss-roll.jpg){:width="160px" height="90px"}
...
{: .center}
![infographix, yo.](/assets/rl/gartner.png){:width="300px"}
