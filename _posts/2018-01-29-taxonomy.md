...
{: .center}
![The ML Taxonomy](/assets/optics/taxonomy.png){:width="250px"}
...
{: .center}
![recent bedroom](/assets/optics/bedroom.png){:width="160px" height="90px"}
![hot topic](/assets/optics/ml-word-cloud.jpg){:width="160px" height="90px"}
![so delicious](/assets/optics/swiss-roll.jpg){:width="160px" height="90px"}
...
The broader field of data science has terminology for all of procedures as well. Indeed, much of ML fits cleanly inside bins of data analytics, laid out in terms of difficulty and value in this chart which I have adapted from a famous infographic of Gartner:

{: .center}
![infographix, yo.](/assets/optics/gartner.png){:width="300px"}
